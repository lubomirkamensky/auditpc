...
requests = None
cachepath="C:/projects/auditpc/machine/cache/crm/"
...
if output == None:
	...
	requests = TimeTree2.crm.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="aia", appname="auditpc", cachepath=cachepath, project="auditpc")
...
utilitygate.recordSystemUsage ("auditpc","3",start)
%>
